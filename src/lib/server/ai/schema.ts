...
export const PrimerContentSchema = z.object({
  ...
  exampleTargetSurface: z.string().min(1).describe("The exact target text copied verbatim from exampleSentence."),
...
export const LearningExerciseContentSchema = z.object({
  ...
  targetSurface: z.string().min(1).describe("The exact target text copied verbatim from japaneseSentence."),
